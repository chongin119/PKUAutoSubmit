...
my_user = 'chongin119@163.com'  # 收件人邮箱账号
...
if __name__ == '__main__':
    ...
    parser.add_argument('--reason', type=str, help='出校原因, eg. 吃饭', default='吃飯')
    parser.add_argument('--destination', type=str, help='出校目的地, eg. 北京', default='北京')
    parser.add_argument('--track', type=str, help='出校轨迹, eg. 畅春园食堂', default='東門-中關村-東門')
